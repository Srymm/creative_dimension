...
execute in dimension:creative run summon minecraft:armor_stand 0 0 0 {Tags : ["dimension_restore_inventory"], NoGravity : 1, Invulnerable : 1, Invisible : 1}
...
execute as @a[scores = {dimension_identifier = 0}] run function dimension:initialize_player